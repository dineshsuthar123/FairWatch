  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 flex h-14 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-6 font-semibold text-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-300 hover:scale-105 hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)] focus:outline-none ${
          isOpen ? "pointer-events-none scale-0 opacity-0" : "scale-100 opacity-100"
        }`}
      >
        <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white/20 text-xs font-bold shadow-inner">
          FW
        </span>
        <span>Fairness Copilot</span>
      </button>

      <div
        className={`fixed bottom-6 right-6 z-50 flex h-[600px] max-h-[80vh] w-[400px] flex-col overflow-hidden rounded-3xl border border-white/20 bg-white/95 shadow-2xl backdrop-blur-xl transition-all duration-300 ease-out sm:max-h-[600px] ${
      ...
      >
        <div className="flex shrink-0 items-center justify-between bg-gradient-to-r from-blue-600 to-indigo-600 p-5 shadow-sm">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white/20 text-sm font-bold shadow-inner backdrop-blur-md">
              FW
            </span>
            <div>
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full bg-black/10 text-white transition hover:bg-black/20"
          >
            x
          </button>
        </div>
